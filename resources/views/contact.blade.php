...
<div class="item-page-main-content pt-5">
        ...
        <div class="item-widget item-white-bg item-wg-title-icon-bg fadeIn" data-effect="fadeIn">
            <div class="item-widget-main-content">
                <div class="item-widget-head">
                    <h2 class="item-widget-title mb-3 text-light">
                        <i class="fas fa-info float-left"></i>@lang('messages.contact_1')		
                    </h2>
                </div>
                <div class="item-widget-content">
                    ...
                    <div class="item-infos-content">
                        <form method="post" action="{{ route('contact.send') }}" enctype="multipart/form-data" id="meetingForm">
                            @csrf
                            <div class="item-infos-item my-2 heading">
                                <div class="item-info-label"><span class="heading-span">@lang('messages.contact_2')</span></div>
                            </div>
                            <div class="item">
                                <div class="row g-3">
                                    <div class="col-md-6 mb-4">
                                        <label for="email" class="form-label">@lang('messages.contact_3')</label>
                                        <input type="email" class="form-control" id="email" name="email" required>
                                    </div>
                                    <div class="col-md-6 mb-4">
                                        <label for="phone" class="form-label">@lang('messages.contact_4')</label>
                                        <input type="text" class="form-control" id="phone" name="phone" placeholder="+1234567890" required>
                                    </div>
                                    <div class="col-md-12 mb-4">
                                        <label for="meeting_status" class="form-label">@lang('messages.contact_5')</label>
                                        <textarea class="form-control" id="message" name="message" rows="4" required></textarea>
                                    </div>
                                    <div class="col-md-12 mb-4">
                                        <label for="attachment" class="form-label">@lang('messages.contact_6')</label>
                                        <input type="file" class="form-control" id="attachment" name="attachment" accept="image/*, .pdf, .doc, .docx">
                                    </div>
                                </div>
                            </div>
                            <div class="text-left">
                                <button type="submit" class="btn btn-primary">@lang('messages.contact_7')</button>
                            </div>
                        </form>
                    </div>
                </div>
