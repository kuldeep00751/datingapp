...
#page-33
    {
    background: url('storage/profilePictures/6788e8d06d0cc.jpg');
    height: auto;
    background-size: 100% 100%;
    display: flex;
    justify-content: center;
            ...
            <div class="item-widget-main-content">
                <!-- <div class="item-widget-head">
                    <h2 class="item-widget-title mb-3">
                        <i class="fas fa-info float-left"></i>Follow-Up 			
                    </h2>
                </div> -->
                <div class="item-widget-content dataflow" >
                    ...
                    <div class="item-infos-content">
                        <form method="post" action="{{ route('meeting.followUp.response') }}" enctype="multipart/form-data" id="meetingForm">
                            @csrf
                            <div class="item-infos-item">
                                <div class="item-info-label text-underline" style="text-decoration: underline;"><h3>Follow-Up After the Date:</h3></div>
                            </div>
                            <div class="item-infos-item my-2 heading">
                                <div class="item-info-label"><span class="heading-span">Have You Met Already?:</span></div>
                            </div>
                            <div class="item">
                                <div class="row g-3">
                                    <div class="col-md-6 mb-2">
                                        <select class="form-control" name="already_meet">
                    ...
                    <img class="page-img-bottom " src="{{asset('/pictures/profile-frame-bottom.png') }}"  />
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="item-widget item-white-bg item-wg-title-icon-bg fadeIn" data-effect="fadeIn">
            <div class="item-widget-main-content">
               <!-- <div class="item-widget-head">
                ...
                <div class="item-widget-content dataflow" id="page-31" >
                <img class="page-img-logo" src="{{asset('pictures/ISO%20G.png') }}"  />
                    <div class="item-infos-content">
                        <h2>Hi Nikhil</h2>
                    <p>We introduce you_</p>
                    <p>Cata</p>
                    </div>
                    
                </div>

                <div class="item-widget-content dataflow" id="page-32" >
                    <img class="page-img-top" src="{{asset('/pictures/profile-frame-top.png') }}" />
                    <h1>CATA</h1>
                    <div class="item-infos-content">
                        <h2><b>The World</b></h2>
                        <p class="title-32">Academic level</p>          
                        <p><strong>Master</strong></p>
                        <p class="title-32">Professional area</p>
                        <p><strong>Marketing</strong></p>
                        <p class="title-32">Enjoys professionally</p>
                        <p><strong>Team work</strong></p>
                        <p class="title-32">Nationality</p>
                        <p><strong>United States</strong></p>
                        <p class="title-32">Languages</p>
                        <p><strong>English</strong></p>
                        <p class="title-32">Residence</p>
                        <p><strong>Utah</strong></p>
                        <p class="title-32">Travel frecuency</p>
                        <p><strong>Part of my free time and vacations</strong></p>
                        <p class="title-32">Social cause</p>
                        <p><strong>Animals and childhood</strong></p>
                ...
                <div class="item-widget-content dataflow" id="page-33"  >
                    <img class="page-img-top" src="{{asset('/pictures/profile-frame-top.png') }}" />
                    
                    
                    <h1>CATA</h1>
                    <div class="item-infos-content">
                    <h2><b>The Essence</b></h2>
                        <p class="title-32">Current stage of life:</p>          
                        <p><strong>Having good moments.</strong></p>
                        <p class="title-32">This stands out in a relationship</p>
                        <p><strong>My understanding of the other person</strong></p>
                        <p class="title-32">This stands out professionally</p>
                        <p><strong>My commitment</strong></p>
                        <p class="title-32">The communication style</p>
                        <p><strong>United States</strong></p>
                        <p class="title-32">This is funny</p>
                        <p><strong>Comedy movies and jokes</strong></p>
                    </div>
                    <img class="page-img-bottom " src="{{asset('/pictures/profile-frame-bottom.png') }}"  />    
                </div>

                <div class="item-widget-content dataflow" id="page-34"  >
                    <img class="page-img-top" src="{{asset('/pictures/profile-frame-top.png') }}" />
                    ...
                    <div class="item-infos-content">
                        ...
                        <h2><b>The Balance</b></h2>
                        <p class="title-32">Children</p>          
                        <p><strong>I have</strong></p>
                        <p class="title-32">Comments</p>
                        <p><strong>I have a 2 years old baby</strong></p>
                        <p class="title-32">¿Could I meet someone with pets?</p>
                        <p><strong>Yes</strong></p>
                        <p class="title-32">Comentarios</p>
                        <p><strong>I love dogs</strong></p>
                        <p class="title-32">Faith / Belief</p>
                        <p><strong>Catholic</strong></p>
                        <p class="title-32">Fitness</p>
                        <p><strong>Sometimes</strong></p>
                        <p class="title-32">Comments</p>
                        <p><strong>I prefer taking care thru food</strong></p>
                        <p class="title-32">The lifestyle and hobbies</p>
                        <p><strong>Quiet and centered in culture development</strong></p>
                    </div>
                    <img class="page-img-bottom " src="{{asset('/pictures/profile-frame-bottom.png') }}"  />    
                </div>

                <div class="item-widget-content dataflow" id="page-35"  >
                    <img class="page-img-top" src="{{asset('/pictures/profile-frame-top.png') }}" />
                    ...
                    <div class="item-infos-content">
                        ...
                        <h2><b>The Basics &<br>Preferences</b></h2>
                        <p class="title-32">Age</p>          
                        <p><strong>68</strong></p>
                        <p class="title-32">Height</p>
                        <p><strong>1,60 mts</strong></p>
                        <p class="title-32">Alcohol</p>
                        <p><strong>I drink eventually</strong></p>
                        <p class="title-32">Cigarrette</p>
                        <p><strong>I never smoke</strong></p>
                        <p class="title-32">I Listen</p>
                        <p><strong>EDM, Rock, Pop, Jazz</strong></p>
                        <p class="title-32">What attracts me</p>
                        <p><strong>Empathy and the way to
treat people and animals</strong></p>
                        <p class="title-32">Interest</p>
                        <p><strong>Woman interested in man</strong></p>
                    </div>
                    <img class="page-img-bottom " src="{{asset('/pictures/profile-frame-bottom.png') }}"  />    
                </div>


                <div class="item-widget-content dataflow" id="page-36"  >
                    <img class="page-img-top" src="{{asset('/pictures/profile-frame-top.png') }}" />
                ...
                <div class="item-widget-content dataflow" id="page-37"  >
                    <img class="page-img-top" src="{{asset('/pictures/profile-frame-top.png') }}" />
                    
                    
                    <h1>CATA</h1>
                    <div class="item-infos-content">
                    <h2><b>What stands out on Silverbridge</b></h2>
                    <p class="sub-title-37 mb-5">These ratings are based in the feedback received</p>
                        <div class="row">
                            <div class="col-md-2 offset-1">
                                <div class="box-imge"><i class="fa fa-user"></i></div>
                            </div>
                            <div class="col-md-8 text-left">
                            <h4 class="tl-37">Photo vs Reality</h4>      
                            <p class="sub-37">It's practically the same as in the photos</p>  
                            </div>

                            <div class="col-md-2 offset-1">
                            <div class="box-imge"><i class="far fa-comment-dots"></i></div>
                            </div>
                            <div class="col-md-8 text-left">
                            <h4 class="tl-37">Level of expresiveness</h4>      
                            <p class="sub-37">Reserved but with moments of eloquence.</p>  
                            </div>

                            <div class="col-md-2 offset-1">
                            <div class="box-imge"><i class="fa fa-handshake-o"></i></div>
                            </div>
                            <div class="col-md-8 text-left">
                            <h4 class="tl-37">Manners</h4>      
                            <p class="sub-37">Balanced.</p>  
                            </div>

                            <div class="col-md-2 offset-1">
                            <div class="box-imge"><i class="fa fa-lightbulb-o"></i></div>
                            </div>
                            <div class="col-md-8 text-left">
                            <h4 class="tl-37">Opinions and Ideas</h4>      
                            <p class="sub-37">Has balanced opinions on topics.</p>  
                            </div>

                            <div class="col-md-2 offset-1">
                            <div class="box-imge"><i class="fa-solid fa-bolt"></i></div>
                            </div>
                            <div class="col-md-8 text-left">
                            <h4 class="tl-37">Energy when interacting</h4>      
                            <p class="sub-37">High</p>  
                            </div>

                            <div class="col-md-2 offset-1">
                            <div class="box-imge"><i class="fa fa-smile-o"></i></div>
                            </div>
                            <div class="col-md-8 text-left">
                            <h4 class="tl-37">Willingness to connect (before the date)</h4>      
                            <p class="sub-37">High: Responds quickly,
shows prior interest.</p>  
                            </div>
                            ...
                            <div class="col-md-8 text-left">
                            <h4 class="tl-37">Highlighted comments </h4>      
                            <p class="sub-37">She is a great person</p>  
                            </div>
                ...
                <div class="item-widget-content dataflow" id="page-38"  >
                    <img class="page-img-top" src="{{asset('/pictures/profile-frame-top.png') }}" />
                    ...
                    <div class="item-infos-content">
                        <div class="row">
                            ...
                            <div class="box-imge"><i class="fa-solid fa-xmark text-danger"></i></div>
                            <p class="text-danger">Not this time</p>
                            </div>
                            <div class="col-md-6 p-3" style=" border-left: 4px solid #fff; ">
                            <div class="box-imge"><i class="fa-solid fa-check text-success"></i></div>
                            <p class="text-success">Let’s try!</p>   
                            </div>   
                        </div>
                    </div>
                    <img class="page-img-bottom " src="{{asset('/pictures/profile-frame-bottom.png') }}"  />    
