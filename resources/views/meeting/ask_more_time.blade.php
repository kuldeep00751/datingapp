            ...
            <div class="item-widget-main-content">
                <div class="item-widget-head">
                    <h2 class="item-widget-title mb-3">
                        <i class="fas fa-info float-left"></i>Need More Time			
                    </h2>
                </div>
                    ...
                    <div class="item-infos-content">
                        @if($messageMeetingResponse)
                            <div class="item-infos-item my-1 alert alert-success" role="alert">
                                <div class="alert alert-success">Need More Time Response has been submitted successfully</div>
                            </div>
                        @else
                        <form method="post" action="{{ route('meeting.moretime.store')}}" enctype="multipart/form-data" id="meetingForm">
                            @csrf
                            <div class="item-infos-item my-2 heading">
                                <div class="item-info-label"><span class="heading-span">Do you need more time?Please Submit your response.</span></div>
                            </div>
                            <div class="item">
                                <div class="row g-3">
                                    <div class="col-md-9 mb-4">
                                        <label for="more_time_status" class="form-label">Status</label>
                                        <select name="more_time_status" class="form-control">
...
$(document).ready(function () {
    $('#meetingForm').on('submit', function (e) {
        ...
        var more_time_status = $('select[name="more_time_status"]').val();
            ...
            success: function (response) {
                if (response.success) {
                    Swal.fire({
                        icon: 'success',
                        title: 'Success!',
                        text: 'Knowing More response updated successfully!',
                    }).then(() => {
                        //  if(continue_meet=='no')
                        //  {
