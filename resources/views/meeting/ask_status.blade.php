            ...
            <div class="item-widget-main-content">
                <div class="item-widget-head">
                    <h2 class="item-widget-title mb-3">
                        <i class="fas fa-info float-left"></i>Meeting Status			
                    </h2>
                </div>
                    ...
                    <div class="item-infos-content">
                        @if($messageMeetingResponse)
                            <div class="item-infos-item my-1 alert alert-success" role="alert">
                                <div class="alert alert-success">Meeting Status has been submitted successfully</div>
                            </div>
                        @else
                        <form method="post" action="{{ route('meetingstatus.store')}}" enctype="multipart/form-data" id="meetingForm">
                            @csrf
                            <div class="item-infos-item my-2 heading">
                                <div class="item-info-label"><span class="heading-span">Did you meet with your connection? Please update your meeting status.</span></div>
                            </div>
                            <div class="item">
                                <div class="row g-3">
                                    <div class="col-md-9 mb-4">
                                        <label for="meeting_status" class="form-label">Meeting Status</label>
                                        <textarea type="text" class="form-control" id="meeting_status" name="meeting_status" value="{{ old('meeting_status') }}" required></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="text-left">
