...
<div class="container py-5" >
    <div class="form-section" id="info" style="color:#fff !important;">
        <form method="post" action="{{ route('cancel.connection.store')}}" enctype="multipart/form-data" id="meetingForm">
            @csrf
            <div class="mb-4 text-center">
                <h3 style="color:#fff !important;">@lang('messages.cancel_connection_1')</h3>
            </div>
            <div class="mb-3">
                <span class="heading-span" style="color:#fff !important;">@lang('messages.follow_up_2')</span>
            </div>
            @if($messageMeetingResponse)
                <div class="item-infos-item my-1 alert alert-success" role="alert">
                    <div class="alert alert-success">@lang('messages.cancel_connection_2')</div>
                </div>
            @else
                <div class="item-infos-item my-2 heading">
                    <div class="item-info-label"><span class="heading-span">@lang('messages.cancel_connection_3').</span></div>
                </div>
                <div class="item">
                    <div class="row g-3">
                        <div class="col-md-9 mb-4">
                            <label for="meeting_status" class="form-label">@lang('messages.cancel_connection_4')</label>
                            <select name="cancel_status" class="form-control">
                                <option value="0">@lang('messages.btn-no')</option>
                                <option value="1">@lang('messages.btn-yes')</option>
                            </select>
                        </div>
                        <div class="col-md-9 mb-4">
                            <label for="meeting_status" class="form-label">@lang('messages.cancel_connection_5')</label>
                            <textarea type="text" class="form-control" id="cancel_reason" name="cancel_reason" value="{{ old('cancel_reason') }}" required></textarea>
                        </div>
                    </div>
                </div>
