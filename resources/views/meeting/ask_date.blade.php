            ...
            <div class="item-widget-main-content">
                <div class="item-widget-head">
                    <h2 class="item-widget-title mb-3">
                        <i class="fas fa-info float-left"></i>Meeting Details			
                    </h2>
                </div>
                    ...
                    <div class="item-infos-content">
                        @if($messageMeetingResponse)
                            <div class="item-infos-item my-1 alert alert-success" role="alert">
                                <div class="alert alert-success">Meeting response has been submitted successfully</div>
                            </div>
                        @else
                        <form method="post" action="{{ route('meeting.store_date')}}" enctype="multipart/form-data" id="meetingForm">
                            @csrf
                            <div class="item-infos-item my-2 heading">
                                <div class="item-info-label"><span class="heading-span">When and where are you planning to meet? (Please provide this information):</span></div>
                            </div>
                            <div class="item">
                                <div class="row g-3">
                                    <div class="col-md-3 mb-4">
                                        ...
                                        <input type="date" 
                                            ...
                                            id="meeting_date" 
                                            name="meeting_date" 
                                            value="{{ old('meeting_date', \Carbon\Carbon::now()->format('Y-m-d')) }}" 
                                            min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}" required>
                                    </div>
                                    <div class="col-md-9 mb-4">
                                        <label for="meeting_place" class="form-label">Meeting Place</label>
                                        <textarea type="text" class="form-control" id="meeting_place" name="meeting_place" value="{{ old('meeting_place') }}" required></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="text-left">
