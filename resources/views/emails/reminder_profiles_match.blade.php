                ...
                <tr>
                    <td style="padding:20px;">
                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="shadow mail-table-item">
                            ...
                            <tr>
                                <td class="body">
                                    <p>@lang('emailsText.reminder_profiles_match_1')
                                    </p>
                                    <p><a href="{{ route('users.show-user', $user->id) }}" style="background-color:#595959;border-color:#595959;color:white;padding: 10px 25px;border-radius:6px;text-decoration:none;font-size: 16px;text-align: center;text-transform: uppercase;">@lang('emailsText.reminder_profiles_match_2')</a></p> 
                                    <p>⏳ @lang('emailsText.reminder_profiles_match_3').</p>
                                </td>
                            </tr>
                            <tr>
                                <td class="body" >
                                    <p>💬 @lang('emailsText.reminder_profiles_match_4')</p>
                                </td>
                            </tr>
