                ...
                <tr>
                    <td style="padding:20px;">
                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="shadow mail-table-item">
                            ...
                            <tr>
                                <td class="heading">
                                    <p style="font-size:15px; color:#455056; line-height:24px; margin:0;">@lang('emailsText.new_profile_matched_1') {{($profile->like_to_be_called)? $profile->like_to_be_called : $profile->email}},</p>
                                </td>
                            </tr>
                            <tr>
                                <td class="body">
                                    <p>✨ @lang('emailsText.new_profile_matched_2') {{$user->like_to_be_called ?$user->like_to_be_called:''}}.</p>
                                    <p>@lang('emailsText.new_profile_matched_3').</p>
                                    <p style="margin-bottom: 1rem;"><a href="{{ route('users.show-user', $user->id) }}" style="background-color:#595959;border-color:#595959;color:white;padding: 10px 25px;border-radius:6px;text-decoration:none;font-size: 16px;text-align: center;text-transform: uppercase;">@lang('emailsText.new_profile_matched_4')</a></p> 
                                </td>
                            </tr>
                            <tr>
                                <td class="body" >
                                    <p>@lang('emailsText.new_profile_matched_5').</p>
                                </td>
                            </tr>
