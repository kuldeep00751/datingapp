                    ...
                    <tr>
                        <td style="padding:20px;">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="shadow mail-table-item">
                                ...
                                <tr>
                                    <td class="heading">
                                        <p>@lang('emailsText.accept_invitation_1') {{$profilesName}},</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="body">
                                        <p>{{$userName}} @lang('emailsText.accept_invitation_2').</p>
                                        <p style="margin-bottom: 1rem;"><a href="{{ route('users.show-user', $user_id) }}" style="background-color:#595959;border-color:#595959;color:white;padding: 10px 25px;border-radius:6px;text-decoration:none;font-size: 16px;text-align: center;text-transform: uppercase;">@lang('emailsText.accept_invitation_3')</a></p> 
                                    </td>
                                </tr>
