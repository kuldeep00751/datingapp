                        ...
                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="shadow mail-table-item">
                            <tr>
                                <td class="body" colspan="2">
                                    <p><strong>@lang('emailsText.contact_1'):</strong> {{ $data['email'] }}</p>
                                    <p><strong>@lang('emailsText.contact_2'):</strong> {{ $data['phone'] }}</p>
                                    <p style="font-size:15px; color:#455056; line-height:24px; margin:2px 0 0px;">{{ $data['message'] }}
                                    </p>
                                    @if(isset($data['attachment']))
                                        <p><strong>@lang('emailsText.contact_3'):</strong> @lang('emailsText.contact_4').</p>
                                    @endif
                                </td>
                            </tr>
