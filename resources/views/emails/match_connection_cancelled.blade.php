            ...
            <tr>
               <td style="padding:20px;">
                  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="shadow mail-table-item">
                     ...
                     <tr>
                        <td class="heading">
                           <p>@lang('emailsText.match_connection_cancelled_1') {{$user->like_to_be_called}},</p>
                        </td>
                     </tr>
                     <tr>
                        <td class="body">
                           <p>@lang('emailsText.match_connection_cancelled_2').</p>
                           <p>@lang('emailsText.match_connection_cancelled_3')</p>
                        </td>
                     </tr>
