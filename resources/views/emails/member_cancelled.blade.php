                    ...
                    <tr>
                        <td style="padding:20px;">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="shadow mail-table-item">
                                ...
                                <tr>
                                    <td class="heading">
                                        <p>@lang('emailsText.member_cancelled_1') {{$user->like_to_be_called}},</p>
                                    <td>
                                </tr>
                                <tr>
                                    <td class="body">
                                        <p>@lang('emailsText.member_cancelled_2')</p>
                                        <p>@lang('emailsText.member_cancelled_3')</p>
                                       
                                        <p style="margin-bottom: 1rem;"><a href="{{ $link }}" style="background-color:#595959;border-color:#595959;color:white;padding: 10px 25px;border-radius:6px;text-decoration:none;font-size: 16px;text-align: center;text-transform: uppercase;">@lang('emailsText.member_cancelled_4')</a></p>

                                        <p>@lang('emailsText.member_cancelled_5'),</p>
                                    </td>
                                </tr>
