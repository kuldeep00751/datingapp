                ...
                <tr>
                    <td style="padding:20px;">
                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="shadow mail-table-item">
                            ...
                            <tr>
                                <td class="heading">
                                    <p>@lang('emailsText.profile_complete_1') {{$user->email}},</p>
                                </td>
                            </tr>
                            <tr>
                                <td class="body">
                                    <p>@lang('emailsText.profile_complete_2'):</p>
                                    <ul>
                                        <li>✅ @lang('emailsText.profile_complete_3').</li>
                                        <li>✅ @lang('emailsText.profile_complete_4').</li>
                                    </ul>

                                    <p>@lang('emailsText.profile_complete_5').</p>
                                    <p>@lang('emailsText.profile_complete_6').</p>
                                </td>
                            </tr>
