                    ...
                    <tr>
                        <td style="padding:20px;">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="shadow mail-table-item">
                                ...
                                <tr>
                                    <td class="heading">
                                        <p>@lang('emailsText.comment_receive_1') {{$profile}},</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="body">
                                        <p>@lang('emailsText.comment_receive_2') {{$user}}</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="body">
                                        <p style="margin-bottom: 1rem;"><a href="{{$link}}" style="background-color:#595959;border-color:#595959;color:white;padding: 10px 25px;border-radius:6px;text-decoration:none;font-size: 16px;text-align: center;text-transform: uppercase;">@lang('emailsText.comment_receive_3')</a></p>
                                    </td>
                                </tr>
