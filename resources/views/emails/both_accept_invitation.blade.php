                ...
                <tr>
                    <td style="padding:20px;">
                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="shadow mail-table-item">
                            ...
                            <tr>
                                <td class="heading">
                                    <p style="font-size:15px; color:#455056; line-height:24px; margin:0;">@lang('emailsText.both_accept_invitation_1') {{ $profilesName  }},</p>
                                </td>
                            </tr>
                            <tr>
                                <td class="body">
                                    <p>@lang('emailsText.both_accept_invitation_2') {{$userName}} @lang('emailsText.both_accept_invitation_3').</p>
                                    <p>✨ @lang('emailsText.both_accept_invitation_4').</p>
                                    
                                    <p>💡 @lang('emailsText.both_accept_invitation_5').
                                    </p>

                                    <p style="margin-bottom: 1rem;"><a href="{{ route('user.chat', $user_id) }}" style="background-color:#595959;border-color:#595959;color:white;padding: 10px 25px;border-radius:6px;text-decoration:none;font-size: 16px;text-align: center;text-transform: uppercase;">@lang('emailsText.both_accept_invitation_6')  </a></p> 
                                </td>
                            </tr> 
