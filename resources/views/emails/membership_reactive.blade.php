                    ...
                    <tr>
                        <td style="padding:20px;">
                            ...
                            <tr >
                                ...
                                <tr>
                                    <td class="heading">
                                        <p>@lang('emailsText.membership_reactive_1') {{($user->like_to_be_called)? $user->like_to_be_called : $user->email}},</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="body">
                                        <p>@lang('emailsText.membership_reactive_2') 🚀 @lang('emailsText.membership_reactive_3').</p>

                                        <p>✅ @lang('emailsText.membership_reactive_4').</p>
                                        <p>✅ @lang('emailsText.membership_reactive_5').</p>
                                        <p>✅ @lang('emailsText.membership_reactive_6')!</p>
                                        <p>@lang('emailsText.membership_reactive_7'):</p>
                                        <p style="margin-bottom: 1rem;"><a href="{{ $link }}" style="background-color:#595959;border-color:#595959;color:white;padding: 10px 25px;border-radius:6px;text-decoration:none;font-size: 16px;text-align: center;text-transform: uppercase;">@lang('emailsText.membership_reactive_8')</a></p>
                                        <p>@lang('emailsText.membership_reactive_9'),</p>
                                    </td>
                                </tr>
