         ...
         <?php
            ...
            if ($user->interested_in === 'Female') {
               ...
               if ($age >= 40) {
                  ...
                  $minAge = is_numeric($user->interested_min_age_range) ? (int) $user->interested_min_age_range : 0;



                  $maxAge = is_numeric($user->interested_max_age_range) ? (int) $user->interested_max_age_range : 0;
            ...
            <div class="item-widget-main-content">
               ...
               <div class="item-widget-content dataflow step" id="page-32" style="background:#00000094;">
                  ...
                  @else
                     ...
                     @if(auth()->user()->id != $user->id)
                     <div class="d-flex">
                         <img  src="{{asset('/pictures/ISO G.png') }}" class="top-logo-23" />
                  ...
                  <div class="item-infos-content" id="data-refresh1">
                     ...
                     <div class="row" id="data-refresh2">
                        ...
                        <a href="{{ route('user.chat',$acceptInvite)}}"  class="item-data-item item-data-comments  col-12 m-1 text-center" data-item-tooltip="0 Comments">
                           ...
                           <img src="{{asset('/pictures//Chat Icon.png')}}" alt="" class="logo-bg" style="width:50%;">
